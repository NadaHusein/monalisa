        ...
        <section id="searchResult">
            ...
            <div class="container">
                <div class="booking-rooms">
                    <h2 class="text-center green">Our Guests List</h2>
                   <div class="d-flex flex-wrap justify-content-between align-items-center">
                      <p>Ahmed Mostafa Mohamed</p>
                       <p>Alaa Elmohammady Ali</p>
                       <p>Noha Elmohammady Ali</p>
                       <p>Nour Eldin Ahmed </p>
                       <p>Karem Naser Elsayed</p>
                       <p>Ahmed Mostafa Mohamed</p>
                       <p>Alaa Elmohammady Ali</p>
                       <p>Nour Eldin Ahmed </p>
                       <p>Doha Naser Elsayed</p>
                       <p>Ahmed Mostafa Mohamed</p>
                       <p>Alaa Elmohammady Ali</p>
                       <p>Nour Eldin Ahmed </p>
                       <p>Karem Naser Elsayed</p>
